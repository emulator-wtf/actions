...
export async function invokeSession(inputs: InvokeSessionInputs): Promise<void> {
...
async function waitForProcessExit(pid: string, totalAttempts = 20, attempt = 0, delayMs = 100): Promise<void> {
...
async function waitForJson (stdout: Readable, adbEnabled: boolean, numberOfDevices: number): Promise<AdbPortOutputs | null> {
